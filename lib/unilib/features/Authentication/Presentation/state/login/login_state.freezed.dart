...
class _$LoginStateTearOff {
  ...
  _Error error({required String email}) {
    return _Error(
      email: email,
    );
  }
...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String email) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(String email)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$_Error implements _Error {
  ...
  @override
  String toString() {
    return 'LoginState.error(email: $email)';
  }
...
abstract class _Error implements LoginState {
  factory _Error({required String email}) = _$_Error;
